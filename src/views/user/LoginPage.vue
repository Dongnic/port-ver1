<template>
  <div class="login">
    ...
    <form @submit.prevent="onSubmit()">
      ...
      <input type="email" name="username" v-model.trim="username" placeholder="이메일 입력" minlength="1" required/><br />
    ...
    &nbsp;
    <a href="/oauth2/authorization/github?redirect_uri=http://localhost:8080/PortChat">
    ...
    &nbsp;
    <a href="/oauth2/authorization/naver?redirect_uri=http://localhost:8080/PortChat">
      <img class="naver login-Logo" src="https://t1.daumcdn.net/cfile/tistory/994331335F52047D05" />
    </a>
    &nbsp;
    <a href="/oauth2/authorization/kakao?redirect_uri=http://localhost:8080/PortChat">
